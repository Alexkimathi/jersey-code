...
export default function BannerForm({ params }: PageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      // image_url required by DB constraint — blank for text-only banners
      image_url: "",
    };
    ...
    <AdminLayout>
      <div className="max-w-2xl p-8">
        ...
        <p className="text-sm text-gray-500 mb-6">
          Banners display text over the background video. To change the video, go to{" "}
          <Link href="/admin/banners/background-video" className="text-blue-600 hover:underline">
            Background Video
          </Link>
          .
        </p>
